...
Откройте файл trigan.png и выберите, значение какой функции больше в точке x = 6. У вас всего одна попытка 
ответить на этот вопрос, будьте внимательны!
'''
...
plt.legend(loc='upper right')
fig.savefig('A:\\task\\trigan.png')


# В точке 6 большее значение у красной функции -- Верный ответ
